...
def rodar_setup_ui():
    ...
    fonte_peca = pygame.font.Font(None, 22) 
    fonte_setas = pygame.font.Font(None, 36) 
    ...
    total_linha_width = 130 + BOX_WIDTH + SELECTOR_WIDTH + 20
    ...
    while rodando:
        ...
        tela.blit(titulo_render, (Config.LARGURA_TELA // 2 - titulo_render.get_width() // 2, 133))

        label_render = fonte_label.render("Selecione a quantidade de jogadores", True, Config.PRETO)
        tela.blit(label_render, (Config.LARGURA_TELA // 2 - label_render.get_width() // 2, 170))
